...
'''
EXERCICIO
Crie uma função insere_na_pilha, que recebe uma pilha e um número
e coloca o número no topo da pilha
'''
def insere_na_pilha(pilha,numero):
    pilha.append(numero)

'''
EXERCICIO
Crie uma função remove_do_topo, que recebe uma pilha, tira o número que
estava no topo e retorna ele

Exemplo: se a pilha era [1,2,3], a pilha deve ficar sendo [1,2] e a função deve retornar 3
'''
def remove_do_topo(pilha):
     removido =pilha.pop()
     return removido
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_010_insere_na_pilha(self):
        pilha_teste1 = [2,3]
        insere_na_pilha(pilha_teste1,4)
        self.assertEqual(pilha_teste1,[2,3,4])
        insere_na_pilha(pilha_teste1,5)
        self.assertEqual(pilha_teste1,[2,3,4,5])
        pilha_teste2 =[]
        insere_na_pilha(pilha_teste2,5)
        self.assertEqual(pilha_teste2,[5])
    
    def test_011_remove_do_topo(self):
        pilha_teste3 = [1,2,3,4,5,6,7]
        topo = remove_do_topo(pilha_teste3)
